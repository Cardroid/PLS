...
def find_path():
    ...
    result_widget_tag = "path_find_result_listbox_widget_tag"
    ...
    real_path_list = pathfinder.get_real_path(path)

    global_data_dict["real_path_list"] = real_path_list

    dpg.configure_item(result_widget_tag, items=[msg for _, _, _, msg, _ in real_path_list])
